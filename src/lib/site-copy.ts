...
export function parseSiteCopy(markdown: string) {
  ...
  return {
    sections,
    // Caption lookup uses Markdown source paths; the renderer prefixes asset URLs.
    imageCaptions: {
      "/images/personal-setup.png": setting("personalSetupCaption"),
      "/images/work-setup.png": setting("workSetupCaption"),
